    ...
    return (
        <section className="relative py-8 px-4">
            ...
            <div className="relative max-w-4xl mx-auto z-10">
                <h2 className="alegreya text-2xl md:text-3xl font-bold text-center mb-2 text-white">Monthly Meetups</h2>
                <p className="text-green-100 text-center text-sm md:text-base mb-6">Explore the vibrant landscape of New Zealand's cryptocurrency innovation and infrastructure.</p>
