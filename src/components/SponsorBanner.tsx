    ...
    return (
        <section className="relative py-12 px-4">
            ...
            <div className="relative max-w-6xl mx-auto z-10">
                ...
                <p className="text-green-100 text-center text-base md:text-lg mb-8">Proudly supported by New Zealand's leading blockchain organizations</p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {sponsors.map((sponsor, index) => (
                        ...
                        >
                            ...
                            >
                                <span className="text-white text-base font-semibold text-center px-3">{sponsor.name}</span>
                            </div>
                        </div>
                    ))}
                </div>
