...
const CryptoWaysSection: React.FC = () => {
    ...
    return (
        <motion.section variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="py-12 sm:py-16 md:py-20">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
                <motion.div variants={itemVariants} className="text-center mb-10 sm:mb-14">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 alegreya">Different Ways to Buy Cryptocurrency in NZ</h2>
                ...
                <motion.div variants={itemVariants} className="mb-12 sm:mb-16">
                    <div className="bg-zinc-800/30 border border-zinc-700/40 rounded-xl overflow-hidden backdrop-blur-sm">
                        ...
                        <div className="p-4 sm:p-6">
                            <div className="space-y-3 sm:space-y-4 text-zinc-100 text-sm sm:text-base">
                                <p>NZ Crypto exchanges like Binance and Kiwi Coin are live exchanges where you can buy, sell, and exchange crypto with other traders in real time.</p>
                                <p>Exchanges are typically custodial, meaning in order to use the exchange you must deposit your crypto / NZD / USD into an account within your exchange. This differs from crypto retailers like Easy Crypto NZ who are almost always non-custodial. (They never hold your coins / orders sent directly to your personal wallet.) Crypto exchanges come with both benefits and drawbacks, as there's potential to save considerable value that would otherwise be spent on gas fees.</p>
                                <p>However, exchanges also pose considerable risks. There's a saying that goes "not your keys, not your coins', referring to the importance of being in control of the private keys associated with your funds. Ultimately, the person with the private keys controls what happens with the crypto, so if you are not the person holding them, you are entrusting a third party to hold your coins. This poses risk as exchanges can be hacked – such as the FTX, Cryptopia, and Mt Gox hacks.</p>
                                <p>At the end of the day, it is up to you as an individual to decide how to manage your crypto. We recommend storing your crypto in a secure self-managed wallet.</p>
                                <div className="mt-4 text-center sm:text-left">
                                    <span className="text-green-400 font-medium">Cryptocurrency NZ recommendations:</span> <span className="text-white font-semibold">Binance</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <motion.div variants={itemVariants} className="mb-12 sm:mb-16">
                    <div className="bg-zinc-800/30 border border-zinc-700/40 rounded-xl overflow-hidden backdrop-blur-sm">
                        ...
                        <div className="p-4 sm:p-6">
                            <div className="space-y-3 sm:space-y-4 text-zinc-100 text-sm sm:text-base">
                                <p>Buying and selling crypto person to person (P2P) is the act of buying, selling, or exchanging cryptocurrency directly between 2 users, without the use of an exchange, retailer, or third party to facilitate the transaction process. It's the way of buying crypto in NZ without having to provide your KYC/personal data.</p>
                                <p>Since 2016, New Zealand AML law has required all NZ crypto services who fall under the VASP classification to collect and provide information on their users to the NZ Govt, including details such as names, wallet addresses, order history, device information, IP addresses and more. P2P traders are those who prefer not to do so.</p>
                ...
                <motion.div variants={itemVariants} className="mb-12 sm:mb-16">
                    <div className="bg-zinc-800/30 border border-zinc-700/40 rounded-xl overflow-hidden backdrop-blur-sm">
                        ...
                        <div className="p-4 sm:p-6">
                            <div className="space-y-3 sm:space-y-4 text-zinc-100 text-sm sm:text-base">
                                <p>Crypto mining is the process of providing computational support to the crypto networks in reward for newly minted coins. You run specialized mining software on your hardware, processing transactions and adding them to blockchain.</p>
                                <p>By running a crypto mining rig, you can earn cryptocurrencies like Bitcoin, Ethereum and Cardano passively; sent safely, directly and privately to your crypto wallet of choice. Mining rigs (more or less) act as civilian money printing machines, with the primary costs being the overhead hardware expenses for your rig and ongoing electricity prices.</p>
                                <div className="mt-2">
                ...
                <motion.div variants={itemVariants} className="mb-12 sm:mb-16">
                    <div className="bg-zinc-800/30 border border-zinc-700/40 rounded-xl overflow-hidden backdrop-blur-sm">
                        ...
                        <div className="p-4 sm:p-6">
                            <div className="space-y-3 sm:space-y-4 text-zinc-100 text-sm sm:text-base">
                                <p>A cryptocurrency airdrop happens when a blockchain project deploys free crypto tokens to their community, usually after meeting specified criteria, for the purpose of marketing and stimulating the circulation of a project's native coin within it's userbase and beyond.</p>
                                <p>Crypto airdrop farming is the deliberate pursuit of exploring and engaging with platforms and project eco-systems who are expected, presumed or likely to deploy an airdrop in the coming future. An airdrop farmer is interested in mass farming crypto airdrops for profit. By far one of the greatest ways to accumulate crypto while exploring the DeFi ecosystem.</p>
                                <div className="mt-2">
                                    <a href="#" className="text-green-400 hover:text-green-300 border-b border-green-500/30 hover:border-green-400/70">
                ...
                <motion.div variants={itemVariants}>
                    <div className="bg-zinc-800/30 border border-zinc-700/40 rounded-xl overflow-hidden backdrop-blur-sm">
                        ...
                        <div className="p-4 sm:p-6">
                            <div className="space-y-3 sm:space-y-4 text-zinc-100 text-sm sm:text-base">
                                <p>Jobs that pay in cryptocurrency have been increasing in popularity and availability over the past 5 years. This is attributed to both the rise in crypto adoption and the sudden rise in working remotely due to the covid-19 pandemic.</p>
                                <p>Stable-coins and crypto in general have broken down many of the barriers that typically held people back from working from a distance for a company abroad. You no longer need to set up bank accounts in different countries – you can now work either here in NZ or internationally and get receive salary or remuneration in digital currency.</p>
                                <p>Seek, LinkedIn, the CNZ Facebook and Discord are a good start.</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
