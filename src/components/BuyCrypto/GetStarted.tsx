    ...
    <section className="relative py-16 md:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl relative z-10">
        ...
        >
          ...
          <p className="mt-6 text-zinc-100 text-base sm:text-lg max-w-3xl mx-auto">
        ...
        >
          ...
          <motion.div 
            ...
            className="border border-zinc-700/40 rounded-xl overflow-hidden backdrop-blur-sm"
          >
            <div className="bg-gradient-to-r from-zinc-800/70 to-zinc-800/50">
              <button 
                onClick={() => toggleStep(1)}
                className="w-full p-5 sm:p-6 flex items-center justify-between focus:outline-none"
              >
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center border border-zinc-700/60 ${expandedSteps[1] ? 'bg-green-500/20 border-green-500/30' : 'bg-zinc-800/70'} transition-all duration-300`}>
                  <svg 
                    className={`w-5 h-5 ${expandedSteps[1] ? 'text-green-400 transform rotate-180' : 'text-zinc-400'} transition-all duration-300`}
                    fill="none" 
                    viewBox="0 0 24 24" 
                    stroke="currentColor"
                  >
            ...
            <div 
              className={`overflow-hidden transition-all duration-300 ${expandedSteps[1] ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}
            >
              <div className="p-5 sm:p-6 border-t border-zinc-700/40 bg-zinc-800/30">
                ...
                <div className="mt-6">
                  <a 
                    href="/bitcoin-guide" 
                    className="inline-flex items-center text-green-400 hover:text-green-300 border-b border-green-500/30 hover:border-green-400/70 transition-all duration-300 group"
                  >
          ...
          >
            <div className="bg-gradient-to-r from-zinc-800/70 to-zinc-800/50">
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center border border-zinc-700/60 ${expandedSteps[2] ? 'bg-green-500/20 border-green-500/30' : 'bg-zinc-800/70'} transition-all duration-300`}>
                  <svg 
                    className={`w-5 h-5 ${expandedSteps[2] ? 'text-green-400 transform rotate-180' : 'text-zinc-400'} transition-all duration-300`}
                    fill="none" 
                    viewBox="0 0 24 24" 
                    stroke="currentColor"
                  >
            ...
            <div 
              className={`overflow-hidden transition-all duration-300 ${expandedSteps[2] ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}
            >
              <div className="p-5 sm:p-6 border-t border-zinc-700/40 bg-zinc-800/30">
                <p className="text-zinc-100">
          ...
          >
            <div className="bg-gradient-to-r from-zinc-800/70 to-zinc-800/50">
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center border border-zinc-700/60 ${expandedSteps[3] ? 'bg-green-500/20 border-green-500/30' : 'bg-zinc-800/70'} transition-all duration-300`}>
                  <svg 
                    className={`w-5 h-5 ${expandedSteps[3] ? 'text-green-400 transform rotate-180' : 'text-zinc-400'} transition-all duration-300`}
                    fill="none" 
                    viewBox="0 0 24 24" 
                    stroke="currentColor"
                  >
            ...
            <div 
              className={`overflow-hidden transition-all duration-300 ${expandedSteps[3] ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}
            >
              <div className="p-5 sm:p-6 border-t border-zinc-700/40 bg-zinc-800/30">
                <p className="text-zinc-100">
          ...
          >
            <div className="bg-gradient-to-r from-zinc-800/70 to-zinc-800/50">
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center border border-zinc-700/60 ${expandedSteps[4] ? 'bg-green-500/20 border-green-500/30' : 'bg-zinc-800/70'} transition-all duration-300`}>
                  <svg 
                    className={`w-5 h-5 ${expandedSteps[4] ? 'text-green-400 transform rotate-180' : 'text-zinc-400'} transition-all duration-300`}
                    fill="none" 
                    viewBox="0 0 24 24" 
                    stroke="currentColor"
                  >
            ...
            <div 
              className={`overflow-hidden transition-all duration-300 ${expandedSteps[4] ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}
            >
              <div className="p-5 sm:p-6 border-t border-zinc-700/40 bg-zinc-800/30">
                <p className="text-zinc-100">
          ...
          >
            <div className="bg-gradient-to-r from-zinc-800/70 to-zinc-800/50">
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center border border-zinc-700/60 ${expandedSteps[5] ? 'bg-green-500/20 border-green-500/30' : 'bg-zinc-800/70'} transition-all duration-300`}>
                  <svg 
                    className={`w-5 h-5 ${expandedSteps[5] ? 'text-green-400 transform rotate-180' : 'text-zinc-400'} transition-all duration-300`}
                    fill="none" 
                    viewBox="0 0 24 24" 
                    stroke="currentColor"
                  >
            ...
            <div 
              className={`overflow-hidden transition-all duration-300 ${expandedSteps[5] ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}
            >
              <div className="p-5 sm:p-6 border-t border-zinc-700/40 bg-zinc-800/30">
                <p className="text-zinc-100">
        ...
        >
          <div className="inline-block px-6 py-3 border border-green-500/30 rounded-lg bg-green-500/10 backdrop-blur-sm">
            <p className="text-zinc-100">
              Need more detailed guidance? <a href="/contact" className="text-green-400 hover:text-green-300 ml-1 transition-colors duration-300">Contact us for personalized advice →</a>
            </p>
          </div>
        </motion.div>
      </div>
