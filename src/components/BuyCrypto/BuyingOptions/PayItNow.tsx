                ...
                <div className="bg-zinc-800/30 border border-zinc-700/40 rounded-xl overflow-hidden backdrop-blur-sm">
                    ...
                    <div className="p-0">
                        ...
                        <div className="relative w-full max-w-full mx-auto aspect-[16/9] bg-zinc-900/50">
                            <img src="./images/PayItNow.png" alt="Pay it Now (PIN) platform" className="w-full h-full object-cover object-top" />
                            ...
                            <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4 flex justify-between items-center">
                                <div className="px-2 sm:px-3 py-1 sm:py-1.5 bg-zinc-900/90 backdrop-blur-sm rounded-md border border-green-500/30 text-zinc-300 text-xs sm:text-sm">
                                    Website:{' '}
                                    <a href="https://www.payitnow.io" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300">
                                        www.payitnow.io
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="px-4 sm:px-5 md:px-6 border-b border-zinc-700/40">
                            <div className="flex overflow-x-auto hide-scrollbar space-x-2 sm:space-x-4 py-3 sm:py-4">
                                <button onClick={() => toggleTab('pin', 'overview')} className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-colors duration-200 ${activeTab['pin'] === 'overview' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'text-zinc-400 hover:text-zinc-200'}`}>
                                    Overview
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="p-4 sm:p-5 md:p-6 min-h-[300px]">
                            ...
                            {activeTab['pin'] === 'overview' && (
                                <div>
                                    <p className="text-zinc-100 text-sm sm:text-base md:text-lg mb-4 sm:mb-6">Pay it Now – PIN is New Zealand's leading crypto payments service, making it easy for businesses to accept Bitcoin, Ethereum and over 15+ other cryptocurrencies in NZ.</p>
                                    ...
                                    <div className="bg-green-900/20 rounded-lg border border-green-500/30 p-3 sm:p-4 mb-4 sm:mb-6">
                                        ...
                                        <p className="text-zinc-100 text-sm sm:text-base mb-3">If you're a business owner looking to accept cryptocurrency payments from your customers, PIN provides a seamless integration that allows you to:</p>
