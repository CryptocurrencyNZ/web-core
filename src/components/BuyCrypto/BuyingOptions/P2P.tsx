                ...
                <div className="bg-zinc-800/30 border border-zinc-700/40 rounded-xl overflow-hidden backdrop-blur-sm">
                    ...
                    <div className="p-0">
                        ...
                        <div className="relative w-full max-w-full mx-auto aspect-[16/9] bg-zinc-900/50">
                            <img src="./images/p2p-marketplace.png" alt="NZ P2P Crypto Marketplace" className="w-full h-full object-cover object-top" />
                            ...
                            <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0">
                                <div className="px-2 sm:px-3 py-1 sm:py-1.5 bg-zinc-900/90 backdrop-blur-sm rounded-md border border-green-500/30 text-zinc-300 text-xs sm:text-sm">
                                    Portal:{' '}
                                    <a href="https://cryptocurrency.org.nz/marketplace" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300">
                                        cryptocurrency.org.nz/marketplace
                                    </a>
                                </div>

                                <div className="px-2 sm:px-3 py-1 sm:py-1.5 bg-red-900/80 backdrop-blur-sm rounded-md border border-red-500/30 text-white text-xs sm:text-sm font-semibold">Warning: High Scam Risk</div>
                            </div>
                        </div>
                        ...
                        <div className="px-4 sm:px-5 md:px-6 border-b border-zinc-700/40">
                            <div className="flex overflow-x-auto hide-scrollbar space-x-2 sm:space-x-4 py-3 sm:py-4">
                                <button onClick={() => toggleTab('p2p', 'overview')} className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-colors duration-200 ${activeTab['p2p'] === 'overview' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'text-zinc-400 hover:text-zinc-200'}`}>
                                    Overview
                                </button>

                                <button onClick={() => toggleTab('p2p', 'why')} className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-colors duration-200 ${activeTab['p2p'] === 'why' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'text-zinc-400 hover:text-zinc-200'}`}>
                                    Why Peer to Peer Matters
                                </button>

                                <button onClick={() => toggleTab('p2p', 'pros-cons')} className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-colors duration-200 ${activeTab['p2p'] === 'pros-cons' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'text-zinc-400 hover:text-zinc-200'}`}>
                                    Pros & Cons
                                </button>

                                <button onClick={() => toggleTab('p2p', 'how-works')} className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-colors duration-200 ${activeTab['p2p'] === 'how-works' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'text-zinc-400 hover:text-zinc-200'}`}>
                                    How It Works
                                </button>

                                <button onClick={() => toggleTab('p2p', 'best-practice')} className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-colors duration-200 ${activeTab['p2p'] === 'best-practice' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'text-zinc-400 hover:text-zinc-200'}`}>
                                    Best Practice
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="p-4 sm:p-5 md:p-6 min-h-[300px]">
                            ...
                            {activeTab['p2p'] === 'overview' && (
                                <div>
                                    ...
                                    <p className="text-zinc-100 text-sm sm:text-base md:text-lg mb-4 sm:mb-6">The NZ P2P Crypto Marketplace was established in 2021 by CNZ's Harry Satoshi to make it easier for Kiwis to discover and communicate with peer-to-peer crypto traders in NZ. It's NZ's best way to locate crypto traders who won't require you to hand over your personal information or perform KYC.</p>
