                    ...
                    <div className="p-0">
                        ...
                        <div className="relative w-full max-w-full mx-auto aspect-[16/9] bg-zinc-900/50">
                            ...
                            <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4 flex justify-between items-center">
                                <div className="px-2 sm:px-3 py-1 sm:py-1.5 bg-zinc-900/90 backdrop-blur-sm rounded-md border border-green-500/30 text-zinc-300 text-xs sm:text-sm">
                                    Website:{' '}
                                    <a href="https://www.binance.com/en-NZ" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300">
                                        www.binance.com/nz
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="px-4 sm:px-5 md:px-6 border-b border-zinc-700/40">
                            <div className="flex overflow-x-auto hide-scrollbar space-x-2 sm:space-x-4 py-3 sm:py-4">
                                <button onClick={() => toggleTab('binance', 'overview')} className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-colors duration-200 ${activeTab['binance'] === 'overview' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'text-zinc-400 hover:text-zinc-200'}`}>
                                    Overview
                                </button>

                                <button onClick={() => toggleTab('binance', 'why')} className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-colors duration-200 ${activeTab['binance'] === 'why' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'text-zinc-400 hover:text-zinc-200'}`}>
                                    Why We Recommend
                                </button>

                                <button onClick={() => toggleTab('binance', 'pros-cons')} className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-colors duration-200 ${activeTab['binance'] === 'pros-cons' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'text-zinc-400 hover:text-zinc-200'}`}>
                                    Pros & Cons
                                </button>

                                <button onClick={() => toggleTab('binance', 'reputation')} className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-colors duration-200 ${activeTab['binance'] === 'reputation' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'text-zinc-400 hover:text-zinc-200'}`}>
                                    Reputation
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="p-4 sm:p-5 md:p-6 min-h-[300px]">
                            ...
                            {activeTab['binance'] === 'overview' && (
                                <div>
                                    <p className="text-zinc-100 text-sm sm:text-base md:text-lg mb-4 sm:mb-6">Binance, the world's largest crypto exchange, is a highly popular platform for Kiwis interested in crypto trading in NZ. Binance offers over 1400 trading pairs, such as NZD to BTC, with some of the lowest fees in the industry.</p>
