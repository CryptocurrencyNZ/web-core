  ...
  const faqItems: FaqItem[] = [
    {
      ...
      answer: (
        <p><span className="font-semibold text-white">Yes</span> – you can buy cryptocurrency in NZ in minutes through one of New Zealand's various crypto retailers or exchanges, such as Easy Crypto NZ.</p>
      )
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          ...
          <p>Learn about your best options in our <a href="/wallets" className="text-green-400 hover:text-green-300 border-b border-green-500/30 hover:border-green-400/70">Best Bitcoin, Ethereum & Crypto Wallets in New Zealand Guide</a>.</p>
        </div>
      )
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          ...
          <p><span className="font-semibold text-white">Alternatives</span> to using regulated services to acquire crypto include crypto mining, buying P2P, airdrops, Crypto ATMs, and decentralized exchanges. You can also get crypto by accepting it as payment for the goods and services you sell, or doing work in exchange for crypto.</p>
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          <p><span className="font-semibold text-white">It takes about 30 minutes to buy Bitcoin, Ethereum and other crypto in NZ</span> – depending on your service of choice. It's possible to sign up with an NZ crypto exchange or retailer like Easy Crypto NZ, verify your account, buy crypto and have it delivered to your personal crypto wallet in 30 minutes or less.</p>
          
          <div>
            <p className="font-semibold text-white mb-2">Crypto buying speeds vary in three key ways:</p>
            <ul className="space-y-2">
              <li><span className="font-semibold text-white">Account creation and verification speeds;</span> the time it takes from signing up with your chosen service to them confirming your identity. <span className="text-zinc-400">(To allow you to buy/sell/exchange)</span></li>
              <li><span className="font-semibold text-white">Order creation and delivery speeds;</span> how long it takes to create, pay for and complete your order – and how long it takes for your chosen service to dispatch your crypto to your personal wallet.</li>
              <li><span className="font-semibold text-white">Network processing speeds;</span> how fast crypto transactions are processed by the crypto networks. <span className="text-zinc-400">(This is not in the control of your chosen service)</span></li>
            </ul>
          </div>
        </div>
      )
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          <p>If you're unsure on what coins to buy, we'd recommend examining <a href="https://coinmarketcap.com/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 border-b border-green-500/30 hover:border-green-400/70">CoinMarketCap</a> to learn about the crypto markets' most popular coins and projects.</p>
    ...
    },
    {
      ...
      answer: (
        <p><span className="font-semibold text-white">Absolutely</span> – selling crypto in NZ is just as easy as buying it. All NZ services showcased below allow users to sell back crypto 24/7, 365 days a year.</p>
      )
    }
  ];
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span className={`ml-4 flex-shrink-0 w-5 h-5 flex items-center justify-center rounded-full 
                    ${openItem === index ? 'bg-green-500/30 text-green-300' : 'bg-zinc-700/50 text-zinc-300'}
                    transition-all duration-300`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`h-4 w-4 transition-transform duration-300 ${openItem === index ? 'transform rotate-180' : ''}`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                {/* Answer content */}
                <div 
                  className={`overflow-hidden transition-all duration-300 ${openItem === index ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'}`}
                >
                  <div className="p-5 sm:p-6 pt-0 text-zinc-100 border-t border-zinc-700/40">
                    {item.answer}
                  </div>
                </div>
              </div>
        ...
        >
          <div className="inline-block px-6 py-3 border border-green-500/30 rounded-lg bg-green-500/10 backdrop-blur-sm">
            <p className="text-zinc-100">
              Ready to start your crypto journey? <a href="#compare-exchanges" className="text-green-400 hover:text-green-300 ml-1 transition-colors duration-300">View all NZ exchanges →</a>
            </p>
          </div>
        </motion.div>
      </div>
