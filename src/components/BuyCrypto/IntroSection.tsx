          ...
          >
            ...
            <div className="relative rounded-xl border border-green-500/30 bg-zinc-800/80 backdrop-blur-sm p-6 sm:p-8 shadow-xl">
              ...
              <div className="space-y-4 relative z-10">
                ...
                <p className="text-base sm:text-lg text-zinc-100 leading-relaxed">
                  Enjoy the process, read all the key information, and don't hesitate to ask us for help on our <a href="/contact" className="text-green-400 hover:text-green-300 border-b border-green-500/30 hover:border-green-400/70 transition-colors duration-300">Contact us</a> page. <em className="text-green-300">Good luck!</em>
                </p>
