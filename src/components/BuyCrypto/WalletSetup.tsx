...
const WalletSetupSection: FC = () => {
    ...
    const setupSteps = [
            ...
            content: (
                <>
                    <p className="text-zinc-100 mb-4">
                        <strong className="text-white">For the desktop application:</strong> head to the official Exodus website on your secure laptop or desktop PC and click on 'download for desktop' –{' '}
                        <a href="https://www.exodus.com/download/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 border-b border-green-500/30 hover:border-green-400/70 transition-colors duration-300">
        ...
        },
        {
            ...
            content: (
                <>
                    <p className="text-zinc-100 mb-4">Once you have downloaded either the desktop or mobile app, open exodus and follow the beginners tutorial that will be prompted on screen.</p>
                    <p className="text-zinc-100">The safest way to backup your recovery phrase is by writing the 12 words down on a piece of paper (ensuring the order and spelling are correct), it is a good practice to have multiple copies of this phrase and keep them in secure locations.</p>
                </>
            )
        },
        {
            ...
            content: (
                <>
                    <p className="text-zinc-100 mb-4">Configure the wallet display settings to your personal preferences, e.g. valued in USD or NZD. Do you prefer the light or dark mode interface? Would you like to enable face-ID authentication (mobile only)? And finally, which assets would you want to see on the portfolio page (over 100 to choose from).</p>
                    <p className="text-zinc-100">
                        See the official Exodus customization guide{' '}
                        <a href="https://support.exodus.com/article/48-getting-started-with-exodus" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 border-b border-green-500/30 hover:border-green-400/70 transition-colors duration-300">
                            here
                        </a>
                        .
                    </p>
    ...
    return (
        <section className="relative py-16 md:py-20 lg:py-24 overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
                    ...
                    <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="w-full lg:w-5/12">
                        ...
                        <div className="space-y-4">
                            <p className="text-zinc-100">A cryptocurrency wallet is a digital account where you store Bitcoin and other cryptocurrencies. The Wallet is a place where you receive payments in and send transactions out, acting as your heart of operations for interacting with the cryptocurrency world. Cryptos like Bitcoin and Ethereum aren't stored in banks, but rather in the user's controlled crypto wallet. This puts you in full control of your digital assets, also making you fully responsible for your wallet safe keeping.</p>

                            <p className="text-zinc-100">This provides crypto users with an unparalleled level of asset security and ownership, all while changing the way millions of people store and transfer value across the globe. Crypto wallets are free to use, safe to operate, and you can have as many wallet accounts as you'd like. Best of all – you don't have to ask anyone for permission to set one up, or use it to send and receive payments. Set up a crypto wallet in NZ and become your own bank in 10 minutes or less.</p>
                        </div>
                            ...
                            <div className="relative">
                                ...
                                <div className="relative overflow-hidden rounded-xl border border-green-500/30 bg-zinc-800/50 backdrop-blur-sm p-6">
                                    <div className="flex items-start">
                                        <img src="./images/exodus-logo.webp" alt="Exodus Wallet Logo" className="w-16 h-16 object-contain mr-4 bg-white p-2 rounded-lg" />
                                        <div>
                                            ...
                                            <a href="https://www.exodus.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-green-400 hover:text-green-300 text-sm border-b border-green-500/30 hover:border-green-400/70 transition-all duration-300 group">
                            ...
                            <div className="mt-6 bg-yellow-900/20 rounded-lg border border-yellow-500/30 p-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-zinc-100 text-sm mt-2">We recommend running a virus scanner such as MalwareBytes on your computer to help ensure your device is secure before creating a new crypto wallet.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.2 }} className="w-full lg:w-7/12">
                            ...
                            <div className="p-6 min-h-[250px]">
                                ...
                                <div className="ml-14">
                                    ...
                                    <div className="mt-6 flex justify-between">
                                        <button onClick={() => setActiveStep((prev) => Math.max(prev - 1, 1))} className={`px-4 py-2 rounded-lg border border-zinc-700/60 text-sm font-medium transition-colors duration-200 ${activeStep > 1 ? 'text-zinc-100 hover:border-green-500/30 hover:bg-green-500/10' : 'text-zinc-500 cursor-not-allowed'}`} disabled={activeStep === 1}>
                                            Previous Step
                                        </button>

                                        <button onClick={() => setActiveStep((prev) => Math.min(prev + 1, setupSteps.length))} className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 ${activeStep < setupSteps.length ? 'bg-green-500 text-zinc-900 hover:bg-green-400' : 'bg-zinc-700 text-zinc-300 cursor-not-allowed'}`} disabled={activeStep === setupSteps.length}>
                        ...
                        {/* Screenshot image */}
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4, duration: 0.7 }} className="mt-8 relative">
                            ...
                            <div className="relative rounded-xl overflow-hidden border border-green-500/30">
                                <img src="./images/Exodus-wallet-with-Bitcoin-Balance-NZD.png" alt="Exodus Wallet Interface" className="w-full object-cover" />
                ...
                {/* CTA at bottom */}
                <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.5, duration: 0.7 }} className="text-center mt-12 md:mt-16">
                    <a
