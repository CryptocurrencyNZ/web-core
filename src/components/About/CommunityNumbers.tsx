...
interface StatCardProps {
  ...
  const StatCard: FC<StatCardProps> = ({ value, label, suffix = '' }) => (
    <div className="border border-green-500/30 rounded-xl p-4 sm:p-5 md:p-6 text-center
      ...
      <AnimatedCounter 
        ...
        suffix={suffix} 
        className="text-3xl sm:text-4xl font-bold text-transparent bg-gradient-to-r from-green-400 to-green-300 bg-clip-text mb-2"
      />
