                    ...
                    <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 md:gap-10 lg:gap-12">
                        ...
                        <div className="lg:w-1/2 order-2 lg:order-1">
                            <div className="border-l-2 border-green-500/50 pl-4 sm:pl-5 md:pl-6 mb-6 sm:mb-8">
                                <p className="text-zinc-100 text-base sm:text-lg mb-4 sm:mb-6">We're the guardians of Aotearoa's largest Bitcoin and crypto Facebook, Reddit, Discord and Meetup groups – home to 50,000+ Kiwi crypto enthusiasts.</p>
                                <p className="text-zinc-100 text-base sm:text-lg mb-4 sm:mb-6">We run monthly DeFi Meetups across 14 of New Zealand's cities, including Auckland, Wellington, Christchurch and beyond, proudly supported by New Zealand's crypto titans.</p>
                                <p className="text-zinc-100 text-base sm:text-lg">Here on the CNZ website, you'll find portals to the corners of our community – as well the backbone of the Cryptocurrency NZ project; our ultra simplified, no bullshit, step-by-step guide on how to get started with Bitcoin & crypto investing in New Zealand.</p>
                            </div>
                            ...
                            <div className="relative group perspective-1000 hidden lg:block">
                                ...
                                >
                                    ...
                                    <div className="relative h-56 sm:h-64 rounded-md overflow-hidden">
                                        <div className="absolute inset-0 bg-cover bg-center opacity-90" style={{ backgroundImage: 'url(./images/CCNZ-bg.png)' }} />
                                        <div className="absolute inset-0 bg-gradient-to-t from-zinc-900/90 via-zinc-800/40 to-transparent" />

                                        <div className="absolute bottom-0 w-full p-4">
                                            <div
                                                className="flex items-center gap-3 text-sm text-zinc-100 bg-gradient-to-r from-green-500/20 to-green-400/5
                                ...
                                <div className="bg-gradient-to-b from-zinc-700/80 to-zinc-800/80 p-3 rounded-lg border border-green-500/30">
                                    <div className="relative">
                                        ...
                                        <div className="relative w-full h-40 sm:h-48 overflow-hidden rounded">
                                            <div className="w-full h-full bg-cover bg-center" style={{ backgroundImage: 'url(./images/CCNZ-bg.png)' }} />
                                            <div className="absolute inset-0 bg-gradient-to-t from-zinc-900/90 via-zinc-800/40 to-transparent" />
