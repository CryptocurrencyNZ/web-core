...
const AboutPageSeo: React.FC<SeoProps> = ({ title = 'About us - Cryptocurrency NZ', description = 'Learn about our conquest to drive cryptocurrency adoption, awareness and community across New Zealand.', canonicalUrl = 'https://cryptocurrency.org.nz/about/', ogImage = 'https://cryptocurrency.org.nz/wp-content/uploads/2023/06/Cryptocurrency-NZ-Aotearoa.png' }) => {
    const schemaData = {
