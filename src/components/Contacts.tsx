                    ...
                    <div className="relative flex flex-col justify-center p-8">
                        ...
                        <div className="flex flex-col items-center text-center space-y-6">
                            ...
                            <a href="#" className="relative group px-8 py-3 bg-transparent overflow-hidden">
                                <div
                                    className="absolute inset-0 bg-green-500 translate-y-full 
                                              group-hover:translate-y-0 transition-transform duration-300"
                                />
                                <span className="relative z-10 text-green-400 font-semibold group-hover:text-black">Join Discord</span>
                            </a>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col items-center space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4 w-full max-w-sm">
                                {socialLinks.map((social, index) => (
                                    ...
                                    >
                                        <div
                                            className="absolute inset-0 bg-green-500/10 translate-x-full 
                                                      group-hover:translate-x-0 transition-transform duration-300"
                                        />
                                        <social.icon
                                            className="relative z-10 w-6 h-6 text-green-400 
